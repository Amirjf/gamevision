  ...
  return (
    <>
      <motion.div
        ...
        } w-full transition-all duration-300 fixed md:static md:block md:w-1/4 z-20 bg-darkGrey py-20 px-6 md:mt-5 lg:mt-5 rounded-md h-screen`}
      >
        <div
        ...
        <div className="text-white md:hidden lg:hidden">
          <span className="">Show Products</span>
        </div>
      </motion.div>
      <div
        onClick={toggleFilters}
      ...
      >
        <div className="bg-darkPurple w-1/4 p-3 rounded-md">
